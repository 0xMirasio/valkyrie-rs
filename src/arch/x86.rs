...
pub const SYSCALL_TABLE_X86: &[(u64, &str)] = &[
    ...
    (250u64, "fadvise64"),
    (251u64, "exit_group"),
    (252u64, "lookup_dcookie"),
    (253u64, "epoll_create"),
    (254u64, "epoll_ctl"),
    (255u64, "epoll_wait"),
    (256u64, "remap_file_pages"),
    (257u64, "set_tid_address"),
    (258u64, "timer_create"),
    (259u64, "timer_settime"),
    (260u64, "timer_gettime"),
    (261u64, "timer_getoverrun"),
    (262u64, "timer_delete"),
    (263u64, "clock_settime"),
    (264u64, "clock_gettime"),
    (265u64, "clock_getres"),
    (266u64, "clock_nanosleep"),
    (267u64, "statfs64"),
    (268u64, "fstatfs64"),
    (269u64, "tgkill"),
    (270u64, "utimes"),
    ...
    (272u64, "vserver"),
    (273u64, "mbind"),
    (274u64, "get_mempolicy"),
    (275u64, "set_mempolicy"),
    (276u64, "mq_open"),
    (277u64, "mq_unlink"),
    (278u64, "mq_timedsend"),
    (279u64, "mq_timedreceive"),
    (280u64, "mq_notify"),
    (281u64, "mq_getsetattr"),
    (282u64, "kexec_load"),
    (283u64, "waitid"),
    (284u64, "add_key"),
    (285u64, "request_key"),
    ...
    (288u64, "ioprio_get"),
    (289u64, "inotify_init"),
    (290u64, "inotify_add_watch"),
    (291u64, "inotify_rm_watch"),
    (292u64, "migrate_pages"),
    (293u64, "openat"),
    (294u64, "mkdirat"),
    (295u64, "mknodat"),
    (296u64, "fchownat"),
    ...
    (307u64, "ppoll"),
    (308u64, "unshare"),
    (309u64, "set_robust_list"),
    (310u64, "get_robust_list"),
    (311u64, "splice"),
    (312u64, "sync_file_range"),
    (313u64, "tee"),
    (314u64, "vmsplice"),
    (315u64, "move_pages"),
    (316u64, "getcpu"),
    ...
    (318u64, "utimensat"),
    (319u64, "signalfd"),
    (320u64, "timerfd_create"),
    (321u64, "eventfd"),
    (322u64, "fallocate"),
    (323u64, "timerfd_settime"),
    (324u64, "timerfd_gettime"),
    (325u64, "signalfd4"),
    (326u64, "eventfd2"),
    (327u64, "epoll_create1"),
    (328u64, "dup3"),
    (329u64, "pipe2"),
    (330u64, "inotify_init1"),
    (331u64, "preadv"),
    (332u64, "pwritev"),
    (333u64, "rt_tgsigqueueinfo"),
    (334u64, "perf_event_open"),
    (335u64, "recvmmsg"),
    (336u64, "fanotify_init"),
    (337u64, "fanotify_mark"),
    (338u64, "prlimit64"),
    (339u64, "name_to_handle_at"),
    (340u64, "open_by_handle_at"),
    (341u64, "clock_adjtime"),
    (342u64, "syncfs"),
    (343u64, "sendmmsg"),
    (344u64, "setns"),
    (345u64, "process_vm_readv"),
    (346u64, "process_vm_writev"),
    (347u64, "kcmp"),
    (348u64, "finit_module"),
    (349u64, "sched_setattr"),
    (350u64, "sched_getattr"),
    (351u64, "renameat2"),
    (352u64, "seccomp"),
    (353u64, "getrandom"),
    (354u64, "memfd_create"),
    ...
    (373u64, "membarrier"),
    (374u64, "mlock2"),
    (375u64, "copy_file_range"),
    (376u64, "preadv2"),
    (377u64, "pwritev2"),
    (378u64, "pkey_mprotect"),
    (379u64, "pkey_alloc"),
    (380u64, "pkey_free"),
    (381u64, "statx"),
    (382u64, "arch_prctl"),
    (383u64, "io_pgetevents"),
    (384u64, "rseq"),
];
